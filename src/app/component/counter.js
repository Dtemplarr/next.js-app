...
function Counter(){
  ...
  return (
    <div className='flex flex-col items-center justify-center min-In-screen bg-gray-1000'>
      ...
      <button onClick={() => setCount(count - 1)} className='px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300 mt-2' >Decrease</button>
    </div>
  )
}
